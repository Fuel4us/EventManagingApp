...
US02
	As an user,
	I want to add an extension of a popup option on the menu of the spreadhsset, by choosing the name and icon.
```

```
US03
	As an user,
	I want to add an extension of a side bar, where I can create new side bars, and choose wich one is opened.
```
