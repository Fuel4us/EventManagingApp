...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JsLexer lexer = new JsLexer(new ANTLRInputStream("console.log(\"$A1 + 1 = \" + ($A1 + 1)); $A1 = \"teste\"; console.log(\"$A1 is now 'test': \" + $A1); $A1 = 1; console.log(\"$A1 is now '1' = \" + $A1); while($A1 < 10){ $A1 = $A1 * 2; } console.log(\"The variable $A1 has the value \" + $A1);"));
